...
call %msbuild% libjpeg-turbo-VS.sln /t:libjpeg-turbo-arm /p:OutDir=../%dstnuget%\lib\native\android\clang\Release\armeabi\ /p:Platform=ARM /p:PlatformToolset=Clang_3_8 /p:Configuration=Release_tatic
...
call %msbuild% libjpeg-turbo-VS.sln /t:libjpeg-turbo-arm64 /p:OutDir=../%dstnuget%\lib\native\android\clang\Release\arm64-v8a\ /p:Platform=ARM64 /p:PlatformToolset=Clang_3_8 /p:Configuration=Release_tatic
...
call %msbuild% libjpeg-turbo-VS.sln /t:libjpeg-turbo-x86 /p:OutDir=../%dstnuget%\lib\native\android\clang\Release\x86\ /p:Platform=x86 /p:PlatformToolset=Clang_3_8 /p:Configuration=Release_tatic
...
call %msbuild% libjpeg-turbo-VS.sln /t:libjpeg-turbo-x64 /p:OutDir=../%dstnuget%\lib\native\android\clang\Release\x86_64\ /p:Platform=x64 /p:PlatformToolset=Clang_3_8 /p:Configuration=Release_tatic
